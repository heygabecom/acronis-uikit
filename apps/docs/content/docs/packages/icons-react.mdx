---
title: icons-react
description: Tree-shakeable React icon components, generated from the Acronis icon sources.
---

import { Callout } from 'fumadocs-ui/components/callout';

`@acronis-platform/icons-react` ships React icon components, **generated** from
the Acronis icon SVG sources. Each icon is a small component that renders one
...
<Callout type="info">
  ...
  with no code change. Treat the numbers above as approximate; the live
  [icon catalog](/docs/icons) is the authoritative list.
</Callout>
...
Browse every available icon in the live [icon catalog](/docs/icons).
