...
```css
@import '@acronis-platform/tokens-pd/css/acronis.css';
@import '@acronis-platform/tokens-pd/css/deep-sky.css'; /* layers on top */
```
...
```ts
// tailwind.config.ts
import tokens from '@acronis-platform/tokens-pd/tailwind/acronis/tokens.js';
import buttonTokens from '@acronis-platform/tokens-pd/tailwind/acronis/components/Button.js';
...
For how to apply these tokens in an app, see [Theming](/docs/theming).
