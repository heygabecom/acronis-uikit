...
description: How tree-shaking works in @acronis-platform/ui-react and best practices for optimal bundle size.
---
...
import { Button } from '@acronis-platform/ui-react/dist/components/ui/button/button';
```
