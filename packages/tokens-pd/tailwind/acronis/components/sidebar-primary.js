...
// Source: @acronis-platform/design-tokens • brand: acronis • component: sidebar-primary
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "sidebar-primary-menu-item-unselected-container-idle": "light-dark(rgb(0 0 0 / 0), rgb(0 0 0 / 0))",
