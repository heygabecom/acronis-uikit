...
// Source: @acronis-platform/design-tokens • brand: deep-sky-itkontoret • component: InputSelect
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "input-select-dropdown-item-selected-container-hover": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "input-select-dropdown-item-selected-container-idle": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "textColor": {
        ...
        "input-select-error-icon-expand-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "fill": {
        ...
        "input-select-normal-icon-disabled": "light-dark(rgb(175 178 182), rgb(85 89 94))",
