...
// Source: @acronis-platform/design-tokens • brand: deep-sky-itkontoret • component: Radio
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "radio-unchecked-box-active": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "fill": {
        ...
        "radio-checked-icon-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "borderRadius": {
        "radio-global-box-border-radius": "50%"
      }
    },
  },
};
