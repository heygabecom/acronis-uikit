...
// Source: @acronis-platform/design-tokens • brand: deep-sky-itkontoret • component: ButtonMenu
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "button-menu-dropdown-item-container-active": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        ...
        "button-menu-secondary-container-active": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "fill": {
        "button-menu-dropdown-extras-cascade-icon": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-menu-dropdown-item-icon": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-menu-primary-icon": "light-dark(rgb(255 255 255), rgb(255 255 255))",
        "button-menu-secondary-icon-active": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-menu-secondary-icon-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "button-menu-secondary-icon-hover": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-menu-secondary-icon-idle": "light-dark(rgb(109 114 120), rgb(109 114 120))"
      },
      "fontFamily": {
