...
// Source: @acronis-platform/design-tokens • brand: deep-sky-itkontoret • component: Button
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "button-secondary-container-active": "light-dark(rgb(215 217 219), rgb(61 63 67))",
      ...
      "textColor": {
        ...
        "button-ai-label-disabled": "light-dark(rgb(255 255 255 / 0.6), rgb(255 255 255 / 0.6))",
        ...
        "button-destructive-label-disabled": "light-dark(rgb(255 255 255 / 0.6), rgb(255 255 255 / 0.6))",
        ...
        "button-primary-label-disabled": "light-dark(rgb(255 255 255 / 0.6), rgb(255 255 255 / 0.6))",
      ...
      "fill": {
        ...
        "button-ghost-icon-active": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-ghost-icon-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "button-ghost-icon-hover": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-ghost-icon-idle": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        ...
        "button-secondary-icon-active": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-secondary-icon-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "button-secondary-icon-hover": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-secondary-icon-idle": "light-dark(rgb(109 114 120), rgb(109 114 120))"
      },
      "fontFamily": {
