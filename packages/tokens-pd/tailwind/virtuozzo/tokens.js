...
// Source: @acronis-platform/design-tokens • brand: virtuozzo • semantic tokens
  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "brand-primary-hover": "light-dark(rgb(77 77 77), rgb(61 63 67))",
      ...
      "textColor": {
        ...
        "on-surface-link-idle": "light-dark(rgb(73 76 80), rgb(201 204 207))",
      ...
      "fill": {
        "on-backdrop-element-primary": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "on-backdrop-screen-primary": "light-dark(rgb(255 255 255), rgb(255 255 255))",
