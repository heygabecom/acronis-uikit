...
// Source: @acronis-platform/design-tokens • brand: virtuozzo • component: Button
  ...
  theme: {
    extend: {
      ...
      "textColor": {
        ...
        "button-secondary-label-active": "light-dark(rgb(73 76 80), rgb(201 204 207))",
        "button-secondary-label-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "button-secondary-label-hover": "light-dark(rgb(73 76 80), rgb(201 204 207))",
        "button-secondary-label-idle": "light-dark(rgb(73 76 80), rgb(201 204 207))"
      },
      "borderColor": {
        "button-secondary-container-border-color-active": "light-dark(rgb(109 114 120), rgb(109 114 120))",
        "button-secondary-container-border-color-disabled": "light-dark(rgb(215 217 219), rgb(61 63 67))",
        "button-secondary-container-border-color-hover": "light-dark(rgb(109 114 120), rgb(109 114 120))",
